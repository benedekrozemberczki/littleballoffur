...
**Little Ball of Fur** consists of state-of-the-art methods to do subsampling on graph structured data. To put it simply it is a Swiss Army knife for graph subsampling tasks. First, it includes a large variety of vertex, edge and expansions sampling techniques. Second, it provides a unified application public interface which makes the application of subsampling algorithms trivial for end-users. Implemented methods cover a wide range of networking ([Networking](https://netscisociety.net/home), [INFOCOM](https://complenet.weebly.com/), [SIGCOMM](https://complenet.weebly.com/)) and data mining ([KDD](http://icdm2019.bigke.org/), [TKDD](http://www.cikm2019.net/), [ICDE](https://www.kdd.org/kdd2020/)), conferences, workshops, and pieces from prominent journals. 
